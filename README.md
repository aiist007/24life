...
本项目是一个现代化的养生指导平台，基于著名中医大师倪海厦的养生理论。除了提供全方位的节气建议外，网站还内置了一个基于大语言模型和本地知识库的问答系统，能够精准引用倪师著作回答用户的健康疑问。
...
- **多维度养生方案**：包含食疗、起居作息、运动导引、穴位按摩、六字诀吐纳等。
- **五行养生智慧**：展示五行相生相克关系，可视化中医养生原理。
- **倪海厦六大健康标准**：内置科学的健康评估体系。
...
| 类别 | 技术 | 备注 |
|-----|------|------|
| **AI/LLM** | Gemini 2.0 | 强劲的逻辑推理能力 |
| **RAG** | Custom TS Implementation | 实现 PDF/EPUB 解析与分词 |
| **前端** | React 19 + Tailwind 4 | 极致的视觉表现 |
| **后端** | Node.js + Express | 负责文档索引与 API 代理 |
| **动画** | Framer Motion | 丝滑的 UI 过渡 |
